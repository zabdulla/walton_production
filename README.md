...
| cieTrade poll | every 10 min | `.github/workflows/cietrade-poll.yml` polls cieTrade in Actions, refreshes the dashboard's Live card and commits the poll log — no Mac needs to be awake (`setup/CIETRADE_API.md`) |
